...
def test_fused_recurrent_retention_with_backward():
    ...
    o, final_state = fused_recurrent_retention(
        q, k, v, initial_state=initial_state, output_final_state=output_final_state
    )
    loss = o.sum()
    loss.backward()
    ...
    o, final_state = fused_recurrent_retention(
        q, k, v, initial_state=initial_state, output_final_state=False
    )
    loss = o.sum()
    loss.backward()
    ...
    o, final_state = fused_recurrent_retention(
        q, k, v, initial_state=initial_state, output_final_state=True
    )
