...
def test_apply_rotary():
    ...
    results["test_case_2"] = apply_rotary(
        x_varlen, cos, sin, cu_seqlens=cu_seqlens, max_seqlen=max_seqlen
    )

    results["test_case_3"] = apply_rotary(
        x, cos, sin, seqlen_offsets, interleaved=True, conjugate=True
    )
