...
def test_fused_native_layer_norm_no_welford():
    ...
    test_case_2 = fused_native_layer_norm_no_welford(
        primals_1, primals_2, primals_3_case2
    )
    ...
    test_case_3 = fused_native_layer_norm_no_welford(
        primals_1_case3, primals_2_case3, primals_3_case3
    )
    ...
    test_case_4 = fused_native_layer_norm_no_welford(
        primals_1_case4, primals_2_case4, primals_3_case4
    )
