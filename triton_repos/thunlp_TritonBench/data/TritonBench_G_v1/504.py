...
def test_chunk_retention():
    ...
    o, final_state = chunk_retention(
        q1, k1, v1, initial_state=None, output_final_state=False
    )
    assert (
        final_state is None
    ), "Final state should be None when output_final_state=False"
    ...
    o, final_state = chunk_retention(
        q2, k2, v2, initial_state=None, output_final_state=True
    )
    assert (
        final_state is not None
    ), "Final state should not be None when output_final_state=True"
    ...
    o, final_state = chunk_retention(
        q3, k3, v3, initial_state=is3, output_final_state=False
    )
    assert (
        final_state is None
    ), "Final state should be None when output_final_state=False and we have initial state"
    ...
    o, final_state = chunk_retention(
        q4, k4, v4, initial_state=is4, output_final_state=True
    )
    assert (
        final_state is not None
    ), "Final state should not be None when output_final_state=True"
