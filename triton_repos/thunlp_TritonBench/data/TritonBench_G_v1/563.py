...
def test_layer_norm_fwd():
    ...
    results["test_case_3"] = _layer_norm_fwd(
        x, weight, bias, eps, x1=x1, weight1=weight1, bias1=bias1
    )

    results["test_case_4"] = _layer_norm_fwd(
        x, weight, bias, eps, dropout_p=dropout_p, return_dropout_mask=True
    )
