...
def test_fast_cross_entropy_loss_with_backward():
    ...
    logits = torch.randn(2, 3, 5, device="cuda:0", requires_grad=True)
    labels = torch.tensor([[1, 2, 3], [0, 1, 4]], device="cuda:0")
    ...
    loss = fast_cross_entropy_loss(
        logits, labels, logit_softcapping=logit_softcapping, logit_scaling=logit_scaling
    )
