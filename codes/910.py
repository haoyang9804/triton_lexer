...
from TritonBench_v1.attention_kernel_aligned import (
...
class performance_metrics(Performance_Metrics):
    def __init__(self, dtype=None, is_backward=False, **kwargs):
        super().__init__(
            "attention_kernel_aligned", dtype=dtype, is_backward=is_backward, **kwargs
        )
        self.input_tensors = []
    ...
    def get_tflops(self, input_tensor, runtime):
        q, _, _, _, _, _ = input_tensor
        FLOPS = 2 * q.size(2) * q.size(3) * q.size(2)
