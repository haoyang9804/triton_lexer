...
def create_ag_gemm_intra_node_context(
    max_M,
    N,
    K,
    input_dtype,
    ...
    barriers = pyrocshmem.hipipc_create_tensor_list(
        tp_group, [m_chunk_num], torch.int32
    )
    ...
    _ag_streams = (
        [torch.cuda.Stream(priority=-1) for i in range(num_ranks)]
