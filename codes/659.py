...
class Operator(BenchmarkOperator):
    ...
    def __init__(
        ...
        self.sizes = list(range(2, 12, 4)) + list(range(12, 23, 3))
    ...
    def torch_jagged_layer_norm_torch_sum(
        ...
        def _inner():
            ...
            padded_normalized = (padded_values - mean) * padded_mask_values
    ...
    def torch_compile_nested_tensor_integration(
        ...
        return lambda: torch_compile_func(x)._values
    ...
    def input_shape(
        ...
        return (
            f"B: {example_inputs[1]}",
            "*",
            f"M: {example_inputs[2]}",
            f"max seqlen: {example_inputs[3]}",
            f"sparsity: {example_inputs[4]}",
        )
