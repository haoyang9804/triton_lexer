...
from TritonBench_v1.attention_forward_triton import forward
...
class performance_metrics(Performance_Metrics):
    def __init__(self, dtype=None, is_backward=False, **kwargs):
        super().__init__(
            "attention_forward_triton", dtype=dtype, is_backward=is_backward, **kwargs
        )
    ...
    def get_tflops(self, input_tensor, runtime):
        ...
        num_operations = 2 * q.size(2) * q.size(3) * q.size(2)
