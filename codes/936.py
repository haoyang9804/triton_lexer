...
class performance_metrics(Performance_Metrics):
    def __init__(
        self, dtype=None, is_backward=False, alpha=1, approximate="none", **kwargs
    ):
    ...
    def call_op(self, input_tuple):
        input_tensor, other_tensor = input_tuple
        return add_gelu(
            input_tensor, other_tensor, alpha=self.alpha, approximate=self.approximate
        )
