...
class performance_metrics(Performance_Metrics):
    def __init__(self, dtype=None, is_backward=False, **kwargs):
        super().__init__(
            "bitwise_and_binomial", dtype=dtype, is_backward=is_backward, **kwargs
        )
    ...
    def call_op(self, input_tuple):
        input_tensor, other_tensor, total_count, probs = input_tuple
        return bitwise_and_binomial(
            input_tensor, other_tensor, total_count, probs=probs
        )
    ...
    def get_gbps(self, input_tuple, runtime):
        ...
        total_bytes = (
            input_bytes + other_bytes + total_count_bytes + probs_bytes + output_bytes
        )
