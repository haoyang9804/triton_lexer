...
parser = argparse.ArgumentParser(
    description="Triton inference pipeline for CRAFT Text Detection"
)
parser.add_argument(
...
parser.add_argument(
    "--canvas_size", default=1100, type=int, help="image size for inference"
)
parser.add_argument(
...
parser.add_argument(
    "--test_folder", default="images/", type=str, help="folder path to input images"
)
...
if __name__ == "__main__":
    ...
    for k, image_path in enumerate(image_list):
        ...
        file_utils.saveResult(
            image_path, image[:, :, ::-1], polys, dirname=result_folder, method="triton"
        )
