...
def bench_scaled_dot_product_attention(
    batch_size, num_heads, seq_len, head_dim, provider, device="cuda"
):

    q = torch.randn(
        [batch_size, num_heads, seq_len, head_dim], dtype=torch.bfloat16, device=device
    )
