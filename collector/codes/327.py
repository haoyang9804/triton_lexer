...
def _layernorm_backward_dLdx(
    ...
    dLdy_ptr,
    w_ptr,
    dLdw_intermediate_ptr,
    dLdb_intermediate_ptr,
    mean_ptr,
    rstd_ptr,
    locks_ptr,
    stride,
...
def _layernorm_backward_dLdw_dLdb(
    ...
    for i in range(0, GROUP_SIZE, BLOCK_SIZE_M):
        ...
        dLdw_acc += tl.load(dLdw_intermediate_ptr + offsets, mask=mask, other=0.0)
        dLdb_acc += tl.load(dLdb_intermediate_ptr + offsets, mask=mask, other=0.0)
