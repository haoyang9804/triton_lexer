...
def memory_read_callback(
    se: SymbolicExecutor, pstate: ProcessState, maccess: MemoryAccess
):
...
def memory_write_callback(
    se: SymbolicExecutor, pstate: ProcessState, maccess: MemoryAccess, value: int
):
