...
from TorchBench_v1.adaptive_avg_pool2d import adaptive_avg_pool2d
...
class performance_metrics(Performance_Metrics):
    def __init__(self, dtype=None, is_backward=False, **kwargs):
        super().__init__(
            "adaptive_avg_pool2d", dtype=dtype, is_backward=is_backward, **kwargs
        )
    ...
    def get_tflops(self, input_tuple, runtime):
        ...
        flops_per_element = avg_kH * avg_kW
