...
@pytest.fixture
def create_chunk_state_scan_bwd_dstate_tensors(
...
def chunk_scan_bwd_dstate_compare(create_chunk_state_scan_bwd_dstate_tensors):
    ...
    C_ref, dout_ref, dA_cumsum_f_ref, dA_cumsum_b_ref = create_ref_tensors(
        *create_chunk_state_scan_bwd_dstate_tensors
    )

    dstates_f = _chunk_scan_bwd_dstates(C, dA_cumsum_f, dout)
    dstates_b = _chunk_scan_bwd_dstates(C, dA_cumsum_b, dout)

    dstates_f_ref, dstates_b_ref = _chunk_scan_bwd_dstates_bi(
        C_ref, dA_cumsum_f_ref, dA_cumsum_b_ref, dout
    )
